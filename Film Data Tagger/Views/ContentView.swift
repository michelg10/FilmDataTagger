...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .overlay(alignment: .bottom) {
            ...
            .offset(y: 6)
            // Block taps on the buttons while they're animating out via
            // .transition — the conditional removes them from the tree but
            // the transition keeps them on-screen and tappable for 0.25s.
